...
The package includes all classes you need for the assigned work.
Your task is to complete the coding of both classes in the package.

To use the file purchases.csv in both classes, 
